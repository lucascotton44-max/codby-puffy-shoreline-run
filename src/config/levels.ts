...
export const LEVELS: LevelDefinition[] = [
  // ── Campaign 1 — Shoreline intro ─────────────────────────────────────────
  {
    ...
    requiredFragments: 6,
    platforms: [
      { x: 405, y: 518, width: 810, height: 70, color: COLORS.shore },
      { x: 610, y: 430, width: 220, height: 22, color: COLORS.dock },
      { x: 950, y: 441, width: 170, height: 22, color: COLORS.dock },
      { x: 1240, y: 518, width: 340, height: 70, color: COLORS.shore },
      { x: 1540, y: 430, width: 220, height: 22, color: COLORS.dock },
      { x: 1785, y: 386, width: 210, height: 22, color: COLORS.dock },
      { x: 2070, y: 518, width: 500, height: 70, color: COLORS.shore },
      { x: 2785, y: 518, width: 930, height: 70, color: COLORS.shore },
      { x: 2870, y: 430, width: 190, height: 22, color: COLORS.dock },
      { x: 3100, y: 375, width: 180, height: 22, color: COLORS.dock },
      { x: 3340, y: 322, width: 200, height: 22, color: COLORS.dock },
      { x: 3850, y: 518, width: 520, height: 70, color: COLORS.shore },
      { x: 4300, y: 518, width: 500, height: 70, color: COLORS.shore },
      { x: 4050, y: 441, width: 190, height: 22, color: COLORS.dock },
      { x: 4250, y: 390, width: 180, height: 22, color: COLORS.dock },
      { x: 4425, y: 344, width: 130, height: 22, color: COLORS.dock },
      { x: 4745, y: 518, width: 390, height: 70, color: COLORS.shore },
      { x: 5090, y: 430, width: 220, height: 22, color: COLORS.dock },
      { x: 5380, y: 382, width: 180, height: 22, color: COLORS.dock },
      { x: 5600, y: 430, width: 230, height: 22, color: COLORS.dock },
      { x: 5880, y: 518, width: 430, height: 70, color: COLORS.shore },
      { x: 6240, y: 430, width: 220, height: 22, color: COLORS.dock },
      { x: 6480, y: 380, width: 220, height: 22, color: COLORS.dock },
      { x: 6760, y: 518, width: 520, height: 70, color: COLORS.shore },
      { x: 7200, y: 518, width: 800, height: 70, color: COLORS.shore },
      { x: 7100, y: 415, width: 280, height: 22, color: COLORS.dock },
    ],
    hazards: [
      { x: 950, y: 515, width: 190, height: 54, kind: 'water' },
      { x: 2030, y: 464, width: 46, height: 34, kind: 'rock' },
      { x: 3420, y: 515, width: 340, height: 54, kind: 'water' },
      { x: 5120, y: 515, width: 340, height: 54, kind: 'water' },
      { x: 5830, y: 464, width: 50, height: 34, kind: 'rock' },
      { x: 6480, y: 356, width: 44, height: 44, kind: 'net' },
    ],
    fragments: [
      { x: 260, y: 430 },
      { x: 620, y: 390 },
    ...
    powerUps: [
      { kind: 'kelpShield', x: 1120, y: 430 },
      { kind: 'tideLift', x: 2870, y: 390 },
      { kind: 'storySpark', x: 4250, y: 350 },
    ],
    scuttleclaws: [
      { x: 2120, y: GROUND_Y - 20, minX: 2080, maxX: 2260, speed: 44, damage: 1 },
      { x: 5980, y: GROUND_Y - 20, minX: 5900, maxX: 6060, speed: 44, damage: 1 },
    ],
    chalkTrigger: {
      x: 42,
      y: GROUND_Y - 32,
